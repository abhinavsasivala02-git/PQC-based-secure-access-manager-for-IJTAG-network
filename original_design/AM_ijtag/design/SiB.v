...
// Engineer: 
// 
// Create Date: 02.06.2025 15:36:54
// Design Name: 
// Module Name: SiB
// Project Name:
// Target Devices:
// Tool Versions:
// Description: Segment Insertion Bit - a 1-bit IJTAG scan cell that
//              dynamically inserts (select_o) or bypasses a downstream
//              instrument segment in the active scan chain, based on the
//              shift_cell/update_cell captured from TDI1.
//
// Dependencies: 
// 
// Revision:
...
module SiB(
    ...
    input wire tck,rst,
    output  wire TDO1,TDI2,select_o
    );
