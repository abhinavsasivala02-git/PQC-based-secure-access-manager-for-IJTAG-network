...
module keccak_round (
    ...
    // Internal lane arrays as wires
    wire [63:0] a [0:4][0:4];    // input state
    reg  [63:0] b [0:4][0:4];    // after theta
    reg  [63:0] c [0:4][0:4];    // after rho
    reg  [63:0] d [0:4][0:4];    // after pi
    reg  [63:0] e [0:4][0:4];    // after chi + iota
    ...
    // --- Theta + Rho + Pi + Chi + Iota (all combinational) ---
