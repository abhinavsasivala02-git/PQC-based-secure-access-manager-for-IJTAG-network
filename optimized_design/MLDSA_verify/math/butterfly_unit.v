// =============================================================================
// butterfly_unit.v — Radix-2 NTT / INTT Butterfly
//
// NTT  (Cooley-Tukey DIT):
//   temp  = MONT_MULT(zeta_mont, b)
//   a_out = (a + temp) mod Q
//   b_out = (a - temp) mod Q
//
// INTT (Gentleman-Sande DIF):
//   a_out = (a + b) mod Q
//   diff  = (a - b) mod Q
//   b_out = MONT_MULT(zeta_mont, diff)
//
// Latency: 5 cycles (4-cycle Montgomery + 1 output register)
// =============================================================================
`timescale 1ns/1ps
