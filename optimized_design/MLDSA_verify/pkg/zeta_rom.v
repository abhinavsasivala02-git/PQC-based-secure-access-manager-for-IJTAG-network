// =============================================================================
// zeta_rom.v — NTT Twiddle Factor ROM (256 x 23-bit, Montgomery form)
//
// Synchronous read (registered output) for SRAM inference in ASIC synthesis.
// Uses case-statement lookup with a clocked output register so that Genus
// can infer a register file or SRAM macro instead of a pure LUT mux tree.
//
// Values from FIPS 204 ML-DSA in Montgomery form (R=2^32).
// Generated from scripts/gen_zeta_table.py output.
// =============================================================================
`timescale 1ns/1ps
...
module zeta_rom (
    ...
    always @(*) begin
        case (addr)
            ...
            8'd25:  rom_out = 23'd4521080;
            8'd26:  rom_out = 23'd6988024;
            ...
            8'd54:  rom_out = 23'd6780509;
            8'd55:  rom_out = 23'd3700620;
            ...
            8'd236: rom_out = 23'd6713241;
            8'd237: rom_out = 23'd7276084;
            8'd238: rom_out = 23'd8119771;
            8'd239: rom_out = 23'd4546524;
            8'd240: rom_out = 23'd5440357;
            8'd241: rom_out = 23'd6078896;
