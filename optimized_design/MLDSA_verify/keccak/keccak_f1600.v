// =============================================================================
// keccak_f1600.v — Keccak-f[1600] Permutation (24 rounds)
//
// Iterates keccak_round 24 times using a state register.
// Latency: 24 clock cycles per permutation.
// Interface: Load state_in on start pulse, read state_out when done.
// =============================================================================
`timescale 1ns/1ps
